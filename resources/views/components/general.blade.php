...
@section('body')
   ...
   <div
      class="bg-dots scheme relative min-h-screen bg-gray-100 bg-center selection:bg-indigo-500 selection:text-white sm:flex sm:items-center sm:justify-center dark:bg-gray-900">
      @yield('content')
